...
import Categories from "../../shared/components/category/categories";
import Products from "../home/products";
import Promo from "../../shared/components/content/promo";
...
const CheckoutDetails = () => {
  ...
  return (
    <>
      {cartCtx.length === 0 && (
        <>
          <p className={styles.emptyCheckout}>Nothing to display. Cart is empty.</p>
          <Categories />
          <Promo />
        </>
      )}
            ...
            <div className={styles.shipping}>
              ...
              <div className={`${styles.grid} ${styles.gridTwo}`}>
                ...
                <div id={styles.zipBlock} className={styles.posRel}>
                  ...
                  <label
                    className={state.zipBlank ? `${styles.label} ${styles.labelError}` : styles.label}
                    htmlFor="zip"
                  >
                    Zip Code
                  </label>
